...
namespace TemplateFox.SDK.Model
{
    ...
    public partial class CreatePdfRequest : IValidatableObject
    {
        ...
        public CreatePdfRequest(string templateId = default, Dictionary<string, Object> data = default, AppRoutersV1PdfExportType? exportType = default, int expiration = 86400, string filename = default, bool storeS3 = false, string s3Filepath = default, string s3Bucket = default, PdfVariant? pdfVariant = default)
        {
