...
namespace TemplateFox.SDK.Model
{
    ...
    public partial class CreateAsyncPdfResponse : IValidatableObject
    {
        ...
        public AppRoutersV1PdfAsyncJobStatus Status { get; set; }
        /// <summary>
        ...
        public CreateAsyncPdfResponse(string jobId = default, AppRoutersV1PdfAsyncJobStatus status = default, int creditsRemaining = default)
        {
