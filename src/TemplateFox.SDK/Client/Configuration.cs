...
namespace TemplateFox.SDK.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/1.9.6/csharp");
            BasePath = "https://api.templatefox.com";
        ...
        public Configuration(
            ...
            string basePath = "https://api.templatefox.com") : this()
        {
        ...
        public static string ToDebugReport()
        {
            ...
            report += "    Version of the API: 1.9.6\n";
            report += "    SDK Package Version: 1.9.6\n";
